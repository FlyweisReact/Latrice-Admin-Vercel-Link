...
import AddNewServiceModal from "../Salon/EditSalon/AddNewServiceModal";
import AddNewStaffModal from "../Salon/EditSalon/AddNewStaffModal";
import EditStaffModal from "../Salon/EditSalon/EditStaffModal";
import EditServiceModal from "../Salon/EditSalon/EditServiceModal";
...
const EditIndependent = () => {
  ...
  // 3 dummy salon images + empty slots
  ...
  return (
    <div className="font-[Rasa] min-h-screen p-2 font-poppins">
      {/* Header */}
      <div className="flex items-center space-x-2 mb-4">
        <div className="cursor-pointer text-[20px]" onClick={() => nav(-1)}><FaArrowLeft /></div>
        <h1 className="text-[50px]  font-semibold font-[Rasa]">Edit Independent Salon</h1>
      </div>
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black/30 z-50">
          ...
          >
            ...
            <p className="text-lg md:text-xl font-medium text-[#232323]">
              You Successfully Edited This Salon.
            </p>
          </div>
        </div>
      )}
